...
function selectElements() {
	...
	passwordConfirmation = fixture.debugElement.query(
		By.css("[data-test=passwordConfirmation]")
	);
	...
	describe("signup form", () => {
		...
		describe("first name input", () => {
			...
			it("should show an error if it has been touched, but empty", () => {
				...
				firstName.nativeElement.dispatchEvent(new Event("input"));
				fixture.detectChanges();
				let firstNameRequired = fixture.debugElement.query(
					By.css("[data-test=firstNameRequired]")
				);
				expect(input.errors["required"]).toBeTruthy();
		...
		describe("last name input", () => {
			...
			it("should show an error if it has been touched, but empty", () => {
				...
				lastName.nativeElement.dispatchEvent(new Event("input"));
				fixture.detectChanges();
				let lastNameRequired = fixture.debugElement.query(
					By.css("[data-test=lastNameRequired]")
				);
				expect(input.errors["required"]).toBeTruthy();
		...
		describe("username", () => {
			...
			it("should show an error when the input is touched but empty", () => {
				...
				fixture.detectChanges();
				let usernameRequired = fixture.debugElement.query(
					By.css("[data-test=usernameRequired]")
				);
				expect(input.errors["required"]).toBeTruthy();
			...
			it("should show an error if the username is too short", () => {
				...
				username.nativeElement.dispatchEvent(new Event("input"));
				fixture.detectChanges();
				let usernameMinLength = fixture.debugElement.query(
					By.css("[data-test=usernameMinLength]")
				);
			...
			it("should show an error if the username is too long", () => {
				...
				username.nativeElement.dispatchEvent(new Event("input"));
				fixture.detectChanges();
				let usernameMaxLength = fixture.debugElement.query(
					By.css("[data-test=usernameMaxLength]")
				);
			...
			it("should show an error if the username contains a space", () => {
				...
				username.nativeElement.dispatchEvent(new Event("input"));
				fixture.detectChanges();
				let usernamePattern = fixture.debugElement.query(
					By.css("[data-test=usernamePattern]")
				);
			...
			it("should show a success message if the username is available", fakeAsync(() => {
				...
				expect(input.errors).toBeFalsy();
				let availableUsername = fixture.debugElement.query(
					By.css("[data-test=usernameAvailable]")
				);
			...
			it("should show an error if the username is taken", fakeAsync(() => {
				...
				expect(input.errors).toBeFalsy();
				let unavailableUsername = fixture.debugElement.query(
					By.css("[data-test=usernameUnavailable]")
				);
				expect(username.classes["is-danger"]).toBeTruthy();
		...
		describe("email", () => {
			...
			it("should show an error when the input is touched and empty", () => {
				...
				email.nativeElement.dispatchEvent(new Event("input"));
				fixture.detectChanges();
				let emailRequired = fixture.debugElement.query(
					By.css("[data-test=emailRequired]")
				);
				expect(input.errors["required"]).toBeTruthy();
			...
			it("should show an error when the text is not an email", () => {
				...
				email.nativeElement.dispatchEvent(new Event("input"));
				fixture.detectChanges();
				let notEmail = fixture.debugElement.query(
					By.css("[data-test=notEmail]")
				);
		...
		describe("password inputs", () => {
			...
			it("should show an error when the field is empty and touched", () => {
				...
				fixture.detectChanges();
				let passwordRequired = fixture.debugElement.query(
					By.css("[data-test=passwordRequired]")
				);
				expect(input.errors["required"]).toBeTruthy();
				...
				fixture.detectChanges();
				let passwordConfirmationRequired = fixture.debugElement.query(
					By.css("[data-test=passwordConfirmationRequired]")
				);
				expect(input2.errors["required"]).toBeTruthy();
			...
			it("should show an error when the password is too short", () => {
				...
				password.nativeElement.dispatchEvent(new Event("input"));
				fixture.detectChanges();
				let passwordLength = fixture.debugElement.query(
					By.css("[data-test=passwordLength]")
				);
				expect(input.errors["minlength"]).toBeTruthy();
				expect(password.classes["is-danger"]).toBeTruthy();
				...
				passwordConfirmation.nativeElement.dispatchEvent(new Event("input"));
				fixture.detectChanges();
				let passwordConfirmationLength = fixture.debugElement.query(
					By.css("[data-test=passwordConfirmationLength]")
				);
			...
			it("should not highlight the input green when the passwords do not match", () => {
				...
				passwordConfirmation.nativeElement.dispatchEvent(new Event("input"));
				fixture.detectChanges();
				let passwordMatch = fixture.debugElement.query(
					By.css("[data-test=passwordMatch]")
				);
		...
		describe("submit", () => {
			...
			it("should not submit if the image is sending", () => {
				...
				expect(formErrorMsg.nativeElement.innerText).toContain(
			...
			it("should return an error if the email is taken and change the email input class", () => {
				...
				let emailTaken = fixture.debugElement.query(
					By.css("[data-test=emailTaken]")
				);
				let notification = fixture.debugElement.query(By.css(".notification"));
				expect(email.classes["is-danger"]).toBeTruthy();
				expect(notification.nativeElement.textContent).toEqual(
				...
				emailTaken = fixture.debugElement.query(
					By.css("[data-test=emailTaken]")
				);
				expect(email.classes["is-success"]).toBeTruthy();
