...
function selectElements() {
	...
	usernamePattern = fixture.debugElement.query(
		By.css("[data-test=usernamePattern]")
	);
	unavailableUsername = fixture.debugElement.query(
		By.css("[data-test=usernameUnavailable]")
	);
	availableUsername = fixture.debugElement.query(
		By.css("[data-test=usernameAvailable]")
	);
	usernameMaxLength = fixture.debugElement.query(
	...
	usernameMinLength = fixture.debugElement.query(
...
describe("EditProfileComponent", () => {
	...
	describe("empty form", () => {
		it("should show an error message if the user tries to submit an empty form", () => {
			...
			expect(errorMsg.nativeElement.innerText).toEqual(
				"You must enter information to change your profile."
			);
		});
	...
	describe("email", () => {
		...
		it("should show an error message when the email is taken and the remove the input error when the email is changed", () => {
			...
			expect(email.classes["is-danger"]).toBeTruthy();
			expect(errorMsg.nativeElement.textContent).toEqual(
