...
export class AdminComponent implements OnInit, OnDestroy {
	...
	adminData = {
		newest: {
			getData: () =>
				this.adminService.getUsersByNewest(this.offset, this.limit),
			selected: false,
		},
		oldest: {
			getData: () =>
				this.adminService.getUsersByOldest(this.offset, this.limit),
			selected: false,
		},
		usernameAtoZ: {
			getData: () =>
				this.adminService.getUsersByUsernameAtoZ(this.offset, this.limit),
			selected: false,
		},
		usernameZtoA: {
			getData: () =>
				this.adminService.getUsersByUsernameZtoA(this.offset, this.limit),
			selected: false,
		},
		firstNameAtoZ: {
			getData: () =>
				this.adminService.getUsersByFirstNameAtoZ(this.offset, this.limit),
			selected: false,
		},
		firstNameZtoA: {
			getData: () =>
				this.adminService.getUsersByFirstNameZtoA(this.offset, this.limit),
			selected: false,
		},
		lastNameAtoZ: {
			getData: () =>
				this.adminService.getUsersByLastNameAtoZ(this.offset, this.limit),
			selected: false,
		},
		lastNameZtoA: {
			getData: () =>
				this.adminService.getUsersByLastNameZtoA(this.offset, this.limit),
			selected: false,
		},
	};
