...
import { UsersAdmin } from "../../utilities/interfaces/users-admin";
...
function selectHeaders() {
	headerSignedUp = fixture.debugElement.query(
		By.css("[data-test=headerSignedUp]")
	);
	headerSignedUpLink = fixture.debugElement.query(
		By.css("[data-test=headerSignedUp] > a")
	);
	headerUsername = fixture.debugElement.query(
		By.css("[data-test=headerUsername]")
	);
	headerUsernameLink = fixture.debugElement.query(
		By.css("[data-test=headerUsername] > a")
	);
	headerFirstName = fixture.debugElement.query(
		By.css("[data-test=headerFirstName]")
	);
	headerFirstNameLink = fixture.debugElement.query(
		By.css("[data-test=headerFirstName] > a")
	);
	headerLastName = fixture.debugElement.query(
		By.css("[data-test=headerLastName]")
	);
	headerLastNameLink = fixture.debugElement.query(
		By.css("[data-test=headerLastName] > a")
	);
}
	...
	describe("error", () => {
		it("should be shown above the table", () => {
			...
			expect(errorMsg.nativeElement.innerText).toEqual(
				"There was an error getting the list of users."
			);
		});
	});
});
