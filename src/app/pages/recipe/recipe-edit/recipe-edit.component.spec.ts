...
describe('RecipeEditComponent', () => {
  ...
  describe('initialization errors', () => {
    it('should return an error if there is no recipe parameter in the url', () => {
      ...
      expect(pageErrorMsg.nativeElement.innerText).toContain('There is no recipe selected to edit.');
    });
    ...
    it('should show an error if the user viewing the page is not the creator of the recipe', () => {
      ...
      selectElements();
      expect(pageErrorMsg.nativeElement.innerText).toContain('You do not have permission to edit this recipe.');
    });
    ...
    it('should show an error if the recipe id in the url is not a number', () => {
      ...
      expect(pageErrorMsg.nativeElement.innerText).toContain('There was an error getting your recipe to edit.');
    });
    ...
    it('should show an error message if there was an error getting the recipe from the server', () => {
      ...
      expect(pageErrorMsg.nativeElement.innerText).toContain('There was an error getting the recipe.');
    });
  });
  ...
  describe('form validation', () => {
    ...
    describe('ingredients and instructions', () => {
      it('should show a message that the inputs are required when empty', () => {
        ...
        let instructionInput = component.editRecipeForm.controls['instructions'];
        ...
        expect(instructionInput['controls'][0].controls['instruction'].errors['required']).toBeTruthy();
      ...
      it('should delete an input for instructions and ingredients and show an error when the user tries to delete the last input', () => {
        ...
        // error message
        expect(ingredientsErrorMsg.nativeElement.innerText).toContain('You must have at least 1 ingredient.');
        expect(instructionsErrorMsg.nativeElement.innerText).toContain('You must have at least 1 instruction.');
