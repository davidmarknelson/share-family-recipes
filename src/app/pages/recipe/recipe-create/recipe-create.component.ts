...
export class RecipeCreateComponent implements OnInit, OnDestroy {
	...
	get cookTime() {
		return this.createRecipeForm.get("cookTime");
	}
	get difficulty() {
		return this.createRecipeForm.get("difficulty");
	}
	get originalRecipeUrl() {
		return this.createRecipeForm.get("originalRecipeUrl");
	}
	get youtubeUrl() {
		return this.createRecipeForm.get("youtubeUrl");
	}
	get mealPic() {
		return this.createRecipeForm.get("mealPic");
	}
