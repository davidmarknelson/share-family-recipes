...
function selectElements() {
	...
	addIngredientInput = fixture.debugElement.query(
		By.css("[data-test=addIngredientInput]")
	);
	removeIngredient = fixture.debugElement.query(
		By.css("[data-test=removeIngredient]")
	);
	instructions = fixture.debugElement.query(By.css("[data-test=instruction]"));
	addInstructionInput = fixture.debugElement.query(
		By.css("[data-test=addInstructionInput]")
	);
	removeInstruction = fixture.debugElement.query(
	...
	unavailableName = fixture.debugElement.query(
		By.css("[data-test=nameUnavailable]")
	);
	nameMaxlength = fixture.debugElement.query(
		By.css("[data-test=nameMaxLength]")
	);
	descriptionRequired = fixture.debugElement.query(
		By.css("[data-test=descriptionRequired]")
	);
	...
	ingredientRows = fixture.debugElement.queryAllNodes(
		By.css("[data-test=ingredient]")
	);
	ingredientErrorMsg = fixture.debugElement.query(
		By.css("[data-test=ingredientErrorMsg]")
	);
	instructionRequired = fixture.debugElement.query(
		By.css("[data-test=instructionRequired]")
	);
	instructionRows = fixture.debugElement.queryAllNodes(
		By.css("[data-test=instruction]")
	);
	instructionErrorMsg = fixture.debugElement.query(
	...
	describe("Create recipe form", () => {
		...
		describe("ingredients", () => {
			it("should be invalid when empty", () => {
				...
				expect(
					input["controls"][0].controls["ingredient"].errors["required"]
				).toEqual(true);
			});
			...
			it("should show an error message when a user tries to delete the only ingredient row", () => {
				...
				expect(ingredientErrorMsg.nativeElement.innerText).toEqual(
		...
		describe("instructions", () => {
			it("should be invalid when empty", () => {
				...
				expect(
					input["controls"][0].controls["instruction"].errors["required"]
				).toEqual(true);
			});
			...
			it("should be valid when an instruction is added", () => {
				...
				input["controls"][0].controls["instruction"].setValue(
					"Put ham between 2 slices of bread."
				);
				instructions.nativeElement.dispatchEvent(new Event("input"));
				fixture.detectChanges();
				selectElements();
			...
			it("should show an error message when a user tries to delete the only ingredient row", () => {
				...
				expect(instructionErrorMsg.nativeElement.innerText).toEqual(
		...
		describe("submit", () => {
			it("should show requirements when user tries to submit without entering information", () => {
				...
				expect(
					form.ingredients["controls"][0].controls["ingredient"].errors[
						"required"
					]
				).toBeTruthy();
				expect(
					form.instructions["controls"][0].controls["instruction"].errors[
						"required"
					]
				).toBeTruthy();
			...
			it("should return an error when there is a server error", () => {
				...
				let notification = fixture.debugElement.query(
					By.css("[data-test=formErrorMsg]")
				);
				expect(notification.nativeElement.innerText).toEqual(
