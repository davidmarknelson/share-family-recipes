...
export class AdminService {
  ...
  getUsersByNewest(offset, limit): Observable<UsersAdmin> {
    return this.http.get<UsersAdmin>(`${this.apiUrl}admin/newusers`, {
      params: {
        offset: offset,
        limit: limit
      }
  ...
  getUsersByOldest(offset, limit): Observable<UsersAdmin> {
    return this.http.get<UsersAdmin>(`${this.apiUrl}admin/oldusers`, {
      params: {
        offset: offset,
        limit: limit
      }
  ...
  getUsersByUsernameAtoZ(offset, limit): Observable<UsersAdmin> {
    return this.http.get<UsersAdmin>(`${this.apiUrl}admin/username-a-z`, {
      params: {
        offset: offset,
        limit: limit
      }
  ...
  getUsersByUsernameZtoA(offset, limit): Observable<UsersAdmin> {
    return this.http.get<UsersAdmin>(`${this.apiUrl}admin/username-z-a`, {
      params: {
        offset: offset,
        limit: limit
      }
  ...
  getUsersByFirstNameAtoZ(offset, limit): Observable<UsersAdmin> {
    return this.http.get<UsersAdmin>(`${this.apiUrl}admin/firstname-a-z`, {
      params: {
        offset: offset,
        limit: limit
      }
  ...
  getUsersByFirstNameZtoA(offset, limit): Observable<UsersAdmin> {
    return this.http.get<UsersAdmin>(`${this.apiUrl}admin/firstname-z-a`, {
      params: {
        offset: offset,
        limit: limit
      }
  ...
  getUsersByLastNameAtoZ(offset, limit): Observable<UsersAdmin> {
    return this.http.get<UsersAdmin>(`${this.apiUrl}admin/lastname-a-z`, {
      params: {
        offset: offset,
        limit: limit
      }
  ...
  getUsersByLastNameZtoA(offset, limit): Observable<UsersAdmin> {
    return this.http.get<UsersAdmin>(`${this.apiUrl}admin/lastname-z-a`, {
      params: {
        offset: offset,
        limit: limit
      }
