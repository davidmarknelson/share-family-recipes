...
// Interfaces
import { RecipeCardInfo } from "../../interfaces/recipe-card-info";
...
export class SearchesService {
	...
	newest(offset, limit): Observable<RecipeCardInfo> {
		return this.http
			.get<RecipeCardInfo>(`${this.apiUrl}search/newest`, {
				params: {
					offset: offset,
					limit: limit,
				},
	...
	oldest(offset, limit): Observable<RecipeCardInfo> {
		return this.http
			.get<RecipeCardInfo>(`${this.apiUrl}search/oldest`, {
				params: {
					offset: offset,
					limit: limit,
				},
	...
	byNamesAtoZ(offset, limit): Observable<RecipeCardInfo> {
		return this.http
			.get<RecipeCardInfo>(`${this.apiUrl}search/names-a-z`, {
				params: {
					offset: offset,
					limit: limit,
				},
	...
	byNamesZtoA(offset, limit): Observable<RecipeCardInfo> {
		return this.http
			.get<RecipeCardInfo>(`${this.apiUrl}search/names-z-a`, {
				params: {
					offset: offset,
					limit: limit,
				},
	...
	ingredientsByNewest(
		...
		return this.http
			.get<RecipeCardInfo>(`${this.apiUrl}search/byingredients-newest`, {
				params: {
					offset: offset,
					limit: limit,
	...
	ingredientsByOldest(
		...
		return this.http
			.get<RecipeCardInfo>(`${this.apiUrl}search/byingredients-oldest`, {
				params: {
					offset: offset,
					limit: limit,
					ingredient: ingredientsArray,
	...
	ingredientsByNameAtoZ(
		offset,
		limit,
		ingredientsArray: Array<string>
	): Observable<RecipeCardInfo> {
		return this.http
			.get<RecipeCardInfo>(`${this.apiUrl}search/byingredients-a-z`, {
				params: {
					offset: offset,
					limit: limit,
					ingredient: ingredientsArray,
	...
	ingredientsByNameZtoA(
		offset,
		limit,
		ingredientsArray: Array<string>
	): Observable<RecipeCardInfo> {
		return this.http
			.get<RecipeCardInfo>(`${this.apiUrl}search/byingredients-z-a`, {
				params: {
					offset: offset,
					limit: limit,
					ingredient: ingredientsArray,
	...
	byUsernameAtoZ(offset, limit, username: string): Observable<RecipeCardInfo> {
		...
		return this.http
			.get<RecipeCardInfo>(`${this.apiUrl}search/byuser-a-z`, {
				params: {
					offset: offset,
					limit: limit,
	...
	byUsernameZtoA(offset, limit, username: string): Observable<RecipeCardInfo> {
		let encodedName = encodeURIComponent(username);
		return this.http
			.get<RecipeCardInfo>(`${this.apiUrl}search/byuser-z-a`, {
				params: {
					offset: offset,
					limit: limit,
					username: decodeURIComponent(encodedName),
	...
	recipesByName(name: string, limit): Observable<Array<AutocompleteItems>> {
		...
		return this.http.get<Array<AutocompleteItems>>(
