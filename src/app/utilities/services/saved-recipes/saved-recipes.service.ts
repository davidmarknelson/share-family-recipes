...
export class SavedRecipesService {
	...
	saveRecipe(recipeId): Observable<any> {
		return this.http.post<any>(`${this.apiUrl}saved/save`, {
			recipeId: recipeId,
		});
	}

	unsaveRecipe(recipeId): Observable<any> {
		return this.http.request<any>("delete", `${this.apiUrl}saved/unsave`, {
	...
	savedRecipesAtoZ(offset, limit): Observable<UserRecipeCardInfo> {
		return this.http
			.get<UserRecipeCardInfo>(`${this.apiUrl}saved/a-z`, {
				params: {
					offset: offset,
					limit: limit,
				},
	...
	savedRecipesZtoA(offset, limit): Observable<UserRecipeCardInfo> {
		return this.http
			.get<UserRecipeCardInfo>(`${this.apiUrl}saved/z-a`, {
				params: {
					offset: offset,
					limit: limit,
				},
